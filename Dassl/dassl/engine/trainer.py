...
class SimpleTrainer(TrainerBase):
    ...
    def build_data_loader(self):
        ...
        self.fed_train_loader_x_dict_new = dm.fed_train_loader_x_dict_new
        self.fed_test_loader_dict_new = dm.fed_test_loader_dict_new
    ...
    @torch.no_grad()
    def test(self, data_loader, split=None, is_global=False, current_epoch=0, idx=-1,global_test=False):
        ...
        for batch_idx, batch in enumerate(tqdm(data_loader)):
            ...
            output = self.model_inference(inputs, idx)
        ...
        return results, running_loss / num_samples
...
class TrainerX(SimpleTrainer):
    ...
    def run_epoch(self, idx=-1, global_epoch=-1, **kwargs):
        ...
        data_time = AverageMeter()
        if idx>=0:
            loader = self.fed_train_loader_x_dict_new[idx]
        else:
